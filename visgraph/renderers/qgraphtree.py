...
class NodeColumn(QtWidgets.QGraphicsItem):
    ...
    def expandNode(self, colnode):
        ...
        if self._v_goleft:
            ...
            nodes = [(n1, self._v_vg.getNodeProps(n1)) for (eid, n1, n2, einfo) in
                     self._v_vg.getRefsToByNid(colnode._v_nid)]
        ...
        if self._v_goright:
            ...
            nodes = [(n2, self._v_vg.getNodeProps(n2)) for (eid, n1, n2, einfo) in
                     self._v_vg.getRefsFromByNid(colnode._v_nid)]
