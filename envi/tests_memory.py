...
class Memory(unittest.TestCase):
    ...
    def test_getMaxReadSize(self):
        mmaps = [(0, envi.const.MM_READ, None, 0x1000 * b'\x41'),
                 (0x1000, envi.const.MM_READ, None, 0x500 * b'\x42'),
                 # gap
                 (0x2000, envi.const.MM_READ, None, 0x100 * b'\x43'),
                 (0x2100, envi.const.MM_NONE, None, 0x1000 * b'\x44'),
                 (0x3100, envi.const.MM_READ, None, 0x200 * b'\x45'),
                 ]
